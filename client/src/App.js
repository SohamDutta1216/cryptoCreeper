...
export default function App() {
  ...
  return (
    <BrowserRouter>
      ...
      <Switch>
        <Route exact path="/" render={() => <Home filteredCoins={filteredCoins} loading={loading} setLoading={setLoading} setPortfolio={setPortfolio} portfolio={portfolio} />} />
        <Route exact path='/portfolio' render={() => <Portfolio portfolioCoins={portfolioCoins} />} />
